...
export const companies: Company[] = [
  {
    ...
    star: 4.5,
    news: {
      pic: "/images/brands/news/snap/1.png",
      ...
      author: {
        name: "امیر رئوفی",
        avatar: "/images/user/avatar/Image.png",
      },
      date: "2025-09-24T06:00:00.000Z",
    },
  },
  {
    name: "کارگزاری فارابی",
    categoryId: "تجارت الکترونیک",
    description:
    ...
    star: 4.6,
    news: {
      pic: "/images/brands/news/snap/2.png",
      title: "اسنپ رکورد خود را با بیش از ۵ میلیون سفر روزانه شکست",
      description:
